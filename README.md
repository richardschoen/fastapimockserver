...
The server can be used to serve up static JSON and CSV files as JSON. JSON files can also be queried using the JMESPath JSON query language. Or you can extend the server with your own API calls.
